package com.stuart.stuartapp.boy;
...
public class MyBoy extends Activity {

    private final String TAG = MyBoy.class.getSimpleName();
     ...
     * **/
    private final String TURING_APIKEY = "37c5072f037f4dbe8db3dc55e1afb370";
    /**
     * 申请的secret（测试使用）
     * **/
    private final String TURING_SECRET = "e32ea0802764d2a7";
    // 百度key（测试使用）
    private final String BD_APIKEY = "02qsoV3AIvYqH2hEkmLvWblE";
    // 百度screte（测试使用）
    private final String BD_SECRET = "172a23b02564d514baa7cade4cd2b708";
